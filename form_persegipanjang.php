...
<head>
    ...
    <title>Program PersegiPanjang</title>
</head>

<body>
    <div class="container">
        <h1 class="text-center">Program PersegiPanjang</h1>
        ...
        if (isset($_POST["submit"])) {
            ...
            echo "Hasil Luas : " . $PP->hitungLuas() . "<br>";
            echo "Hasil Keliling : " . $PP->hitungKeliling() . "<br>";
        }
